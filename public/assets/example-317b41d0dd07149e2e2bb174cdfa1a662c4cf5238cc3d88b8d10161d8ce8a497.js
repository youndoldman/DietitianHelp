		...
		datasets : [
			{
				...
				data : [parent.querySelector("#bmispan").innerHTML,randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]
			},
			{
