...
var weight3;
        ...
        datasets : [
            {
                ...
                data : [weight1,document.getElementById("30daysinput").value,25,randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]
            },
            {
 ...
 function chart(){
    ...
    var weight1 += document.getElementById("30daysinput").value; 
    var weight2 += document.getElementById("60daysinput").value;
    var weight3 += document.getElementById("180daysinput").value;
