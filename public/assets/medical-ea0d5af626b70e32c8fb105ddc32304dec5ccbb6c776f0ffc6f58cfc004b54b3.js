...
function gender() {
      ...
      if(document.getElementById('switch5').checked) {
          genderval = 'female';
      document.getElementById("genderfspan").style.display = "block"
      document.getElementById("gendermspan").style.display = "none"

}
      if(document.getElementById('switch5').checked == false) {
        genderval = 'male';
      document.getElementById("genderfspan").style.display = "none"
      document.getElementById("gendermspan").style.display = "block"
}
};
function ibw() { 
