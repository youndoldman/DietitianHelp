...
var weight1 = function() { return document.getElementById("30daysinput").value};
        ...
        datasets : [
            {
                ...
                data : [parseInt(weight1()),document.getElementById("30daysinput").value,25,randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]
            },
            {
