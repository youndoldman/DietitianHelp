...
var weight3;
        ...
        datasets : [
            {
                ...
                data : [Math.round(Number(weight1)),23,25,randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]
            },
            {
 ...
 function chart(){
    ...
    weight1 = document.getElementById("30daysinput").value; 
    weight2 = document.getElementById("60daysinput").value;
    weight3 = document.getElementById("180daysinput").value;
