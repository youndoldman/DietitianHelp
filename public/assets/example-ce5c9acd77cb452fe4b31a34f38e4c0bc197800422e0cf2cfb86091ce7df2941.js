...
var weight1 = function() {return Math.round(document.getElementById("30daysinput").value)};
...
console.log(Math.round(document.getElementById("30daysinput").value));
var ctx2 = document.getElementById("chart-line").getContext("2d");
      window.myLine = new Chart(ctx2).Line(lineChartData, { labels : ["January","February","March","April","May","June","July"],
        datasets : [
            {
                ...
                data : [weight1(),20,25,randomScalingFactor(),randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]
            },
            {
